...
into a host language. Since SMT-LIB is s-expression-based, a Lisp seemed like a
natural choice for a host language. We chose Racket~\cite{racket} as the host
