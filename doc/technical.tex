...
Racket function to do the same thing:
...
eliminates universal quantifiers that are macros in disguise. We can now
provide a Racket macro, \texttt{smt:define-fun}, that has the same syntax as
the SMT-LIB command and that performs precisely this transformation.
